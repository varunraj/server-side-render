...
var _AdminLIstPage = __webpack_require__(26);
...
exports.default = [_extends({}, _App2.default, { // below routes to be nested inside app.no path tied to this, so always displayed.
    routes: [_extends({}, _HomePage2.default, { // this is same as component:HomePage.component
        path: '/',
        exact: true
...
var Header = function Header(_ref) {
    ...
    // we need to proxy through api path in server
